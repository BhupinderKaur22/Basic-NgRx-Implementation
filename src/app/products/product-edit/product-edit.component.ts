...
export class ProductEditComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.currentProduct$ = this.store.select(getCurrentProduct).pipe(tap(
  ...
  saveProduct(originalProduct: Product): void {
    if (this.productForm.valid) {
      if (this.productForm.dirty) {
        ...
        this.productForm.controls.starRating.setValue(Number(this.productForm.controls.starRating.value));
